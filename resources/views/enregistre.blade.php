                    ...
                    {!! Form::open(['route' => 'students.store', 'id' => 'contact-form']) !!}
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input id="" type="text" name="matricule" class="form-input" placeholder="Le matricule de l'étudiant">
                                <p class="comments"></p>
                            </div>
                            <div class="col-md-6 mb-2">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="date" name="birthday" id="date" placeholder="Date de naissance">
                                <!-- <input id="" type="number" name="" class="form-input" placeholder="Le matricule de l'étudiant"> -->
                                <p class="comments"></p>
                            </div>
                            <div class="col-md-6 mb-2">
