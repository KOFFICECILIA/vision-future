    ...
    <div class="main-content">
        <section class="descip-box">
            <div class="container-fluid">
                <div class="description">
                    ...
                    La philosophie de notre structure : discrétion au service de l’efficacité.
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="work-section">
            <div class="container">
                <div class="row">
                    <div class="col-3">
                        <div class="card my-card my-card-height">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="row">
                            <div class="col-6 mb-4">
                                <div class="date-box">
                                    <h1>FEV <span class="number-date"> 08</span></h1>
                            ...
                            <div class="col-6 mb-4">
                                <div class="card b-none">
                                    <img src="{{asset('images/event1.jpg')}}" style="height:20rem" alt="">
                                </div>
                            </div>
                            <div class="col-6 mb-4">
                                <div class="date-box">
                            ...
                            <div class="col-6 mb-4">
                                <div class="card b-none">
                                    <img src="{{asset('images/event2.png')}}" style="height:20rem" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 mb-4">
                        <div class="row">
                            <div class="col-6 mb-4">
                                <div class="card b-none">
                                    <img src="{{asset('images/event3.jpg')}}" style="height:20rem" alt="">
                                </div>
                            </div>
                            <div class="col-6 mb-4">
                                <div class="date-box">
                            ...
                            <div class="col-6 mb-4">
                                <div class="card b-none">
                                    <img src="{{asset('images/img5.jpg')}}" style="height:20rem" alt="">
                                </div>
                            </div>
                            <div class="col-6 mb-4">
                                <div class="date-box">
